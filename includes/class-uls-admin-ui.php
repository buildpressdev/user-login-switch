...
class ULS_Admin_UI {
	...
	public function enqueue_frontend_assets() {
		...
		wp_localize_script(
			...
			array(
				...
				'empty_label'    => esc_html__( 'No users available.', 'user-login-switch' ),
				'error_label'    => esc_html__( 'Could not load users. Please try again.', 'user-login-switch' ),
				'search_label'   => esc_html__( 'Search users', 'user-login-switch' ),
				'return_label'   => esc_html__( 'Return to Original Admin', 'user-login-switch' ),
				'no_access_text' => esc_html__( 'Switching is not available in this session. Use return button.', 'user-login-switch' ),
			)
		);
	}
	...
	public function render_frontend_widget() {
		...
		<div class="uls-widget uls-widget--<?php echo esc_attr( $position ); ?>" id="uls-widget-root">
			<button class="uls-widget__toggle" type="button" aria-expanded="false" aria-controls="uls-widget-panel">
			...
			<section class="uls-widget__panel" id="uls-widget-panel" hidden aria-label="<?php esc_attr_e( 'User switcher', 'user-login-switch' ); ?>">
				<header class="uls-widget__head">
					<strong><?php esc_html_e( 'Quick Switch', 'user-login-switch' ); ?></strong>
				...
				<div class="uls-widget__body">
					<div class="uls-widget__search-wrap" hidden>
						<label class="screen-reader-text" for="uls-user-search"><?php esc_html_e( 'Search users', 'user-login-switch' ); ?></label>
						<input id="uls-user-search" class="uls-widget__search" type="search" autocomplete="off" placeholder="<?php esc_attr_e( 'Search users...', 'user-login-switch' ); ?>" />
					</div>
				...
				<?php if ( $this->switch_manager->is_switched() ) : ?>
					<footer class="uls-widget__footer">
						<a class="uls-widget__return" href="<?php echo esc_url( $this->switch_manager->return_url() ); ?>"><?php esc_html_e( 'Return to Original Admin', 'user-login-switch' ); ?></a>
					</footer>
				<?php endif; ?>
			</section>
		</div>
